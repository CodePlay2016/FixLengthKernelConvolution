...
namespace mxnet {
namespace op {
DMLC_REGISTER_PARAMETER(MyConvolutionParam);

template<>
Operator* CreateOp<cpu>(MyConvolutionParam param, int dtype,
                        std::vector<TShape> *in_shape,
                        std::vector<TShape> *out_shape,
                        Context ctx) {
  Operator *op = NULL;
  MSHADOW_REAL_TYPE_SWITCH(dtype, DType, {
    op = new MyConvolutionOp<cpu, DType>(param);
  })
  return op;
}

// DO_BIND_DISPATCH comes from operator_common.h
Operator *MyConvolutionProp::CreateOperatorEx(Context ctx,
                                            std::vector<TShape> *in_shape,
...
/*
mxnet.ndarray.contrib.MyConvolution(data=None, kernel_masks=None, weight=None, bias=None,
...
MXNET_REGISTER_OP_PROPERTY(_contrib_MyConvolution, MyConvolutionProp)
...
.add_argument("data", "NDArray-or-Symbol", "Input data to the MyConvolutionOp.")
.add_argument("kernel_masks", "NDArray-or-Symbol", "the kernel mask matrix.")
.add_argument("weight", "NDArray-or-Symbol", "Weight matrix.")
.add_argument("bias", "NDArray-or-Symbol", "Bias parameter.")
.add_arguments(MyConvolutionParam::__FIELDS__());
